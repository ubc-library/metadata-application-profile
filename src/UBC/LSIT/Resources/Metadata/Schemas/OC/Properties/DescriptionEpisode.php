<?php
    ...
    class DescriptionEpisode extends Property
    {
        private $uriPart = 'descriptionEpisode';//http://purl.org/dc/terms/#uriPart

        private $namePart = 'descriptionEpisode';//Term Name: #name
