<?php
    ...
    class PeerReviewStatus extends Property
    {
        private $uriPart = 'peerReviewStatus';//http://purl.org/dc/terms/#uriPart

        private $namePart = 'peerReviewStatus';//Term Name: #name
