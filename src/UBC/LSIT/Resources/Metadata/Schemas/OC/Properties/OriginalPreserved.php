<?php
    ...
    class OriginalPreserved extends Property
    {
        private $uriPart = 'originalPreserved';//http://purl.org/dc/terms/#uriPart

        private $namePart = 'originalPreserved';//Term Name: #name
